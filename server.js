...
debug('process.env.SERIAL: ' + process.env.SERIAL);
debug('process.env.CANSPEED: ' + process.env.CANSPEED);
debug('process.env.BAUD: ' + process.env.BAUD);
...
app.listen(3005, () => console.error('listening on http://localhost:3005/'));
